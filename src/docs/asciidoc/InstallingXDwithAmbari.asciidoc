...
This document describes the initial installation process. For upgrade instructions please refer to link:UpgradingXDwithAmbari.asciidoc[Upgrading to Spring XD 1.3.1.RELEASE using Ambari].
